...
export const RULES = {
    ...
    combat: {
        ...
        damageReductionSystem: {
            enabled: false, // off until magic weapons are in loot pool
        ...
        damageTypes: {
            ...
            psychic: ['psychic'],
            resonant: ['resonant'],
            neutral: ['injury', 'resonant'], // never resisted or exploited
            dotCapable: ['blood', 'fire', 'cold', 'lightning', 'poison', 'necrotic', 'acid', 'void'],
        },
    ...
    magicItems: {
        ...
        // added to d6 based on encounter difficulty (avgCR - playerLevel delta)
        encounterBonus: {
            easy:   -1,
            normal:  0,
            hard:    1,
        ...
        // avgCR - playerLevel delta thresholds that map to each difficulty label
        crDeltaThresholds: {
            easy:   -2,
            normal:  0,
            hard:    2,
        ...
        // flat bonus when a boss is in the encounter
        bossBonusModifier: 1,

        // added to d6 based on the completing quest's difficulty
        questBonus: {
            easy:   0,
            normal: 0,
            hard:   1,
    ...
    skillChallenges: {
        ...
        balancing: {
            ...
            // very_high: Skills that already provide major benefits (cunning = sneak attack + combat avoidance)
            ...
            skillValueMultipliers: {
                very_high: 0.5,   // 50% rewards (cunning, perception)
            ...
            lootChanceBySkillValue: {
                very_high: 0.3,   // 30% base loot chance (cunning, perception)
