...
export class Character {
    ...
    calculateAC() {
        ...
        ac += getPassiveACBonus(this.fightingStyle, {
            wearingArmor: !!this.equipment.armor,
            heavyArmor: this.equipment.armor?.armorType === 'heavy',
            shield: this.equipment.offHand?.type === 'shield',
        });
